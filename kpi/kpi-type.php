<?php $page="admim-kpi"; $ac="kpi-type"; session_start();?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <div class="page-header">
                                                <div class="card-block">
                                                    ...
                                                    <ul class="breadcrumb-title  p-t-10">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">GROUP KPIs </a>
                                                        </li>
                                                    </ul>

                                                    <div class="text-right">
                                                        <button type="button" class="btn btn-warning btn-outline-warning waves-effect md-trigger" data-modal="modal-15" onclick="ClearData()">Add GROUP KPIs</button>
                                                    </div>
...
FROM tb_kpi_type  WHERE kpi_types = '1'
";
                                        ...
                                        <div class="card-block" id="contents">
                                            <form class="md-float-material" action="../class/sql-insert.php" method="post">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="kpi_type_name" class="form-control color-class" placeholder="ระบุชื่อการประเมิน" maxlength="50" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <input type="hidden" name="kpi_types" value="1">
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header pt-2 pb-2 btnh_primary">
                                                <h5 class="modal-title" id="exampleModalLabel">GROUP KPIs</h5>
