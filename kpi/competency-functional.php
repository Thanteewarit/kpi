<!DOCTYPE html>
<html lang="en">
<?php $page="competency"; $ac="functional"; ?> 
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>สมรรถนะและพฤติกรรมการบริหารจัดการ (Functional Competency)</h5>
                                            </div>
                                                    ...
                                                    <table id="new-cons2" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr style="background: #2a97a5;">
                                                                <td>1. Problem Solving and Decision Making (การแก้ไขปัญหา และการตัดสินใจ)</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                   1. <?php echo $i+1;?> จัดลำดับความสำคัญของปัญหาได้อย่างถูกต้องเหมาะสม</td>
                                                            ...
                                                            <?php }?>
                                                            <tr style="background: #2a97a5;">
                                                                <td>2. Problem Solving and Decision Making (การแก้ไขปัญหา และการตัดสินใจ)</td>
                                                                <td> <?php //echo $r['ap_weight']?></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                   2. <?php echo $i+1;?> จัดลำดับความสำคัญของปัญหาได้อย่างถูกต้องเหมาะสม</td>
                                                                <td class="tabledit-edit-mode">
                                                                    <select class="tabledit-input form-control input-sm" onchange="onCompanyChange(this.value,'<?php echo $r1['ct_Id']?>')"  required >
                                                                        <option value="">กรุณาเลือกคะแนน</option>
                                                                        <option value="0" <?php if($arr['cv_Values']=="0"){ echo "selected";}?>>0</option>
