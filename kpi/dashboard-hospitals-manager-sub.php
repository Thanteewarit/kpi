...
<?php $page="dashboard"; $ac="dashboard-hospitals-manager-sub"; session_start();?> 
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <?php if($Tid!=""){ $_SESSION["division_manager_head_id"]=$Tid; }?>
    <!-- Favicon icon -->
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                             <?php 
                                                            $valuei="
                                                            SELECT * FROM tb_division_manager_sub WHere director_assistant_id='".$_SESSION["director_assistant_id"]."' AND  
                                                            division_director_id = '".$_SESSION["division_director_id"]."' AND
                                                            division_manager_head_id = '".$_SESSION["division_manager_head_id"]."' AND
                                                            division_manager_sub_Status = 'Y' ";
                                                            foreach(c_scelectS($valuei) AS $key => $r){ ?>
                                                            <tr>
                                                                 <td><?php echo $key+1;?></td>
                                                                <td><?php echo $r['division_manager_sub_Name'];?></td>
                                                                <td>3.5</td>
                                                                <td><a href="dashboard-hospitals-depatment-head.php?key=<?php echo TokenGen($r['division_manager_sub_id'], $secret)?>"><button class="btn btn-info">ดูรายละเอียด</button></a></td>
