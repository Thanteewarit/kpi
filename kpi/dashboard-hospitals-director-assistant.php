<?php $page="dashboard"; $ac="dashboard-hospitals-director-assistant"; session_start();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <?php if($Tid!=""){ $_SESSION["hospitals"]=$Tid; }?>
    <!-- Favicon icon -->
 ...
 <div class="page-header">
                                                <div class="card-block">
                                                    ...
                                                    <ul class="breadcrumb-title  p-t-10">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#">Hospital director assistant</a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                             <?php 
                                                            $valuei="
                                                            SELECT * FROM tb_hospital_director_assistant WHere director_assistant_Status = 'Y' ";
                                                            foreach(c_scelectS($valuei) AS $key => $r){ ?>
                                                            <tr>
                                                                 <td><?php echo $key+1;?></td>
                                                                <td><?php echo $r['director_assistant_Name'];?></td>
                                                                <td>3.5</td>
                                                                <td><a href="dashboard-hospitals-division_director.php?key=<?php echo TokenGen($r['director_assistant_id'], $secret)?>"><button class="btn btn-info">ดูรายละเอียด</button></a></td>
                                                            </tr>
                                                            <?php } ?>
                                                        </tbody>
                                                        <tfoot>
