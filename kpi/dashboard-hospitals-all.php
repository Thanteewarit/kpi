<?php $page="dashboard"; $ac="dashboard-hospitals-all"; session_start();?>
<!DOCTYPE html>
<html lang="en">
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                             <?php 
                                                            $valuei="
                                                            SELECT * FROM tb_hospital WHere hospital_Status = 'Y' ";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>3.5</td>
                                                                <td><a href="dashboard-hospitals-director-assistant.php?key=<?php echo TokenGen($r['hospital_id'], $secret)?>"><button class="btn btn-info">ดูรายละเอียด</button></a></td>
                                                            </tr>
                                                            <?php } ?>
                                                        </tbody>
                                                        <tfoot>
