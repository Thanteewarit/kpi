                                            ...
                                            <div class="page-header">
                                                <div class="card-block">
                                                    ...
                                                    <ul class="breadcrumb-title  p-t-10">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">อับไฟล์ Set KPIs </a>
                                                        </li>
                                                    </ul>
                                                    <div class="text-right">
                                                        <button type="button" class="btn btn-warning btn-outline-warning waves-effect md-trigger" data-modal="modal-15" onclick="ClearData()">Set KPIs</button>
                                                    </div>
                                                </div>
                                                <hr style="width: 95%;">
                                            </div>
                                            <div class="card-block">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $valuei = "SELECT * FROM tb_assessment_time WHERE fileTime ='" . $_SESSION['filename'] . "' AND fileTime !='' ";
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $r['assessment_time_type']; ?></td>
                                                                </tr>
                                                            <?php
                                                            } ?>
                                                        </tbody>
                                            ...
                                            <form class="md-float-material" action="../class/sql-insert.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <input type="hidden" name="Mode" value="upCsvFileSetName">
                                                    </div>
                                                </div>
