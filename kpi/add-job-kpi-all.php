<?php $page="add-assessment"; $ac="add-job-kpi-all"; session_start();?>
<!DOCTYPE html>
<html lang="en">
...
-->
                                            ...
                                            <form class="md-float-material" action="../class/sql-insert.php"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <select name="assessment_time_type" id="assessment_time_type"
                                                            ...
                                                            <option value="<?php echo $r['type_code_id']; ?>">
                                                                <?php echo $r['type_code_name'] ?></option>
                                                            <?php }?>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control staff_Name"
                                                            name="staff_Name" width="300px" value="">
                                                        <input type="hidden" class="staff_code" name="staff_code"
                                                            id="staff_code" value="">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <input type="hidden" name="Mode" value="addOneEvaluation">
    ...
    <script>
        ...
        $(".staff_Name").autocomplete({
            ...
            select: function (event, ui) {
                $(".staff_code").val(value = ui.item.staff_code);
                $(".staff_Name").val(ui.item.staff_Name + " " + ui.item.label);
            }
