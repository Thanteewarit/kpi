<?php $page="add-assessment"; $ac="add-department-kpin"; session_start();?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <div class="page-header">
                                                <div class="card-block">
                                                    ...
                                                    <ul class="breadcrumb-title  p-t-10">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">รายชื่อผู้มีสิทธิ์ การประเมิน</a>
                                                        </li>
                                                        <!--
...
";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo DateThai($r['assessment_time_start']);?> -<?php echo DateThai($r['assessment_time_end']);?></td>
                                                                <td>100</td>
                                                                <td><a href="add-assessment-all.php?key=<?php echo TokenGen($r['assessment_time_code'], $secret)?>&month=<?php echo $r['evaluation_month'];?>"><button type="button" class="btn btn-primary btn-mini btn-outline-primary waves-effect md-trigger" data-modal="modal-add">ดูข้อมูล</button></a></td>
                                                                <td><a href="../class/sql-insert.php?key=<?php echo TokenGen($r['assessment_time_code'], $secret)?>&Mode=delect-dev-kpi"><button onclick="return confirm('คุณต้องการลบ ? Code : <?php echo $r['assessment_time_code']?>');" type="button" class="btn btn-primary btn-mini btn-outline-primary waves-effect md-trigger">ลบ</button></a></td>
                                                            </tr>
                                                            <?php } ?>
                                                        </tbody>
                                                        <tfoot>
                                            ...
                                            <form class="md-float-material" action="../class/sql-insert.php" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <select name="hospital_id" id="hospital_id" onchange="getDate0()" class="form-control form-control-info">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="depatment_head_id" id="depatment_head_id" class="form-control" required onchange="">
...
-->
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control job_grade_name" name="job_grade_name" width="300px" required>
                                                        <input type="hidden" name="staff_code" id="job_grade_name" value="">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <input type="hidden" name="Mode" value="addEvaluationDepartment">
                                                        <input type="hidden" id="assessment_time_type" value="2">
