...
<head>
    ...
    <!-- amchart css -->
    <link rel="stylesheet" type="text/css" href="../files/assets/pages/dashboard/amchart/css/amchart.css">
    <!--SVG Icons Animated-->
    <link rel="stylesheet" type="text/css" href="../files/assets/icon/SVG-animated/svg-weather.css">
    <!-- Font Awesome -->
...
-->
                        <a href="#">
                            <img class="img-fluid" src="../image/logo_principal.png" style="height: 34px;" />
                        </a>
...
-->
                            <li class="user-profile header-notification">
                                <a href="#!">
                                    <img src="../image/images.jpeg" class="img-radius" alt="User-Profile-Image">
                                    <span>นายธรรม์ธีวริทธิ์ ตุ้มขาว</span>
                                    ...
                                    <div class="page-body m-t-40">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-12">
                                                <div class="card seo-card">
                                                    <img src="../files/assets/images/widget/seoimg1.jpg" alt="seo bg" class="img-fluid">
                                                    <div class="overlay-bg bg-c-blue"></div>
                                                    <div class="card-block seo-content">
                                                        <span class="label label-success">Traffic</span>
                                                        <h4 class="m-t-10">Devices and resolution</h4>
                                                        <p class="m-b-0 m-t-20">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-12">
