<?php $page="add-assessment"; $ac="add-assessment-competency-all"; session_start();?>
<!DOCTYPE html>
<html lang="en">
...
-->
                                ...
                                <div class="md-modal md-effect-15" id="modal-15">
                                    <div class="md-content">
                                        <h3>เพิ่มรู้ประเมิน competency</h3>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <input type="hidden" name="Mode"
                                                            value="addOneEvaluationCompetency">
...
<script>
        $('#data-table6').DataTable({
            ...
            serverSide: true,
            "ajax": {
                "url": "../class/class.php?Mode=add-assessment-competency.php",
                "type": "POST"
            }
