<?php $page="add-assessment"; $ac="add-behavior-kpi"; session_start();?>
<!DOCTYPE html>
<html lang="en">
...
-->
                                        ...
                                        <form class="md-float-material" action="../class/sql-insert.php"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <input type="hidden" name="Mode" value="addEvaluation2">
                                                        <input type="hidden" name="SetVlues" value="1">
                                                        <input type="hidden" id="assessment_time_type" value="8">
    ...
    <script>
        $('#data-table6').DataTable({
            ...
            serverSide: true,
            "ajax": {
                "url": "../class/class.php?Mode=add-behavior-kpi.php",
                "type": "POST"
            }
