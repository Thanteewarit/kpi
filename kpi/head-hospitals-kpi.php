                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="card" style="padding-bottom:30px;">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-6">
                                                    <h5 class="card-header-text" style="margin-top: 30px;">Hospitals KPIs</h5>
                                                </div>
                                                <div class="text-right col-6">
                                                    <button onclick="goBack()" type="button" style="margin-top: 20px;" class="btn btn-success alert-confirm m-b-10"><i class="fa fa-mail-reply"></i>ย้อนกลับ</button>
...
AND r1.evaluation_all_hospital_id = '$H1'
AND r1.evaluation_all_director_assistant_id = '$H2'
AND r1.evaluation_all_division_director_id = '$H3'
AND r1.evaluation_all_division_manager_head_id = '$H4'
AND r1.evaluation_all_division_manager_sub_id = '$H5'
AND r1.evaluation_all_depatment_head_id = '$H6'
AND r1.evaluation_all_year = '$year'
AND r2.kpi_type_id = l1.kpi_type_id
AND r3.assessment_time_type = '1' ) !='0'
                                                        ";
                                                        foreach(c_scelectS($valuei) AS $key => $r){ ?>
                                                        <tr>
                                                        
                                                            <td colspan="19" style="background-color: #64a6ff70;"><?php echo $r['kpi_type_name'];?>...<?php echo $r['kpi_type_id']?></td>
                                                        </tr>
                                                        <?php 
...
AND r3.assessment_time_type = '1' 

";

                                                        foreach(c_scelectS($valuei) AS $key1 => $r){


                                                        ?>
                                                        <tr>

                                                            <td><?php echo $r['kpi_master_name']?><?php echo $r['evaluation_all_id']?><?php echo $H1;?></td>
                                                            <td><?php echo $r['kpi_master_weight']?></td>
                                                            <td><?php echo $r['kpi_master_target']?></td>
                                                            <td><input type="text" class="form-control k1<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_1']?>" <?php if ($month!="01"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k1'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>

                                                            <td><input type="text" class="form-control k2<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_2']?>" <?php if ($month!="02"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k2'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>

                                                            <td><input type="text" class="form-control k3<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_3']?>" <?php if ($month!="03"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k3'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>

                                                            <td><input type="text" class="form-control k4<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_4']?>" <?php if ($month!="04"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k4'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>

                                                            <td><input type="text" class="form-control k5<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_5']?>" <?php if ($month!="05"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k5'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>

                                                            <td><input type="text" class="form-control k6<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_6']?>" <?php if ($month!="06"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k6'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>

                                                            <td><input type="text" class="form-control k7<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_7']?>" <?php if ($month!="07"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k7'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>

                                                            <td><input type="text" class="form-control k8<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_8']?>" <?php if ($month!="08"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k8'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>

                                                            <td><input type="text" class="form-control k9<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_9']?>" <?php if ($month!="09"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k9'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>

                                                            <td><input type="text" class="form-control k10<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_10']?>" <?php if ($month!="10"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k10'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>

                                                            <td><input type="text" class="form-control k11<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_11']?>" <?php if ($month!="11"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k11'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>

                                                            <td><input type="text" class="form-control k12<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_12']?>" <?php if ($month!="12"){ echo "disabled"; }?> onchange="inPutDate(<?php echo $r["evaluation_type"]?>,<?php echo $r["kpi_master_id"]?>,'k12'+<?php echo $r['evaluation_all_id'];?>,this.value,<?php echo $r['evaluation_all_id'];?>,<?php echo $r['evaluation_id']?>)"></td>
                                                ...
                                                <div class="general-info">
                                                    <div class="card-header">
                                                        <div class="card-header-right" style="margin-right:25px; margin-bottom:30px;">
                                                            <h5>
                                                                <span id="ks" style="display:inline;"></span> / 100.00
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header pt-2 pb-2 btnh_primary">
                                            <h5 class="modal-title" id="exampleModalLabel">Hospitals KPIs</h5>
...
<script>
    ...
    function inPutDate(type, id, csid, valueIn, evaluation_all_id,evaluation_id) {
        $.ajax({
            url: "../class/class.php",
            global: false,
            type: "POST",
            ...
            success: function(jd) {
                $.each(jd, function(key, val) {
                    getScore(val["kpi_master_standard_1"], val["kpi_masterl_standard_2"], val["kpi_master_standard_3"], val["kpi_master_standard_4"], val["kpi_master_standard_5"], val["kpi_master_weight"], id, csid, valueIn, type, evaluation_all_id,evaluation_id);
    ...
    function getScore(v1, v2, v3, v4, v5, Weight, kpi_master_id, csid, valueIn, typeIn, evaluation_all_id,evaluation_id) {
        //var csid = $("#csid").val()
        ...
        $.ajax({
            ...
            success: function(jd) {
                $.each(jd, function(key, val) {
                    ...
                    SumsScore(val["valueAll"], v1, v2, v3, v4, v5, Weight, evaluation_all_id, typeIn,evaluation_id);
                });
            }
        });
    }

    function SumsScore(valueIn, v1, v2, v3, v4, v5, Weight, evaluation_all_id, typeIn,evaluation_id) {
        console.log("==========SumsScore============"); 
        console.log(valueIn);
        console.log(v1);
        console.log(v2);
        console.log(v3);
    ...
    function sumScoreAll() {
        ...
        $("#ks").empty().append(sumValue.toFixed(2)/5*100);
        In_scoreHospitals(sumValue.toFixed(2));

    }

    function In_scoreHospitals(Srcore) {
        $.ajax({
            url: "../class/class-calculate.php",
            global: false,
            type: "POST",
            data: ({
                id_staff: '<?php echo $staff; ?>',
                Mode: "In_scoreHospitals",
                Srcore: Srcore
    ...
    function getScoreInscore(v1, v2, v3, v4, v5, id, Weight, evaluation_all_id, evaluation_id) {
        $.ajax({
            ...
            data: ({
                ...
                Weight: Weight,
                evaluation_id : evaluation_id,
                evaluation_key : <?php echo $_GET['evaluation_key']?>
            }),
            dataType: "JSON",
            async: false,
            success: function(jd) {
    ...
    function getCompetencyVlues(competency_code, Facter) {
        $.ajax({
            ...
            success: function(jd) {
                $.each(jd, function(key, val) {
                    if (Facter == "MC") {
                        $("#mcIn").empty().append(val["vluesIn"] + ' / ' + val["VluesTarget"]);
                    }
                    if (Facter == "FC") {
                        $("#fcIn").empty().append(val["vluesIn"] + ' / ' + val["VluesTarget"]);
                    }
                    if (Facter == "CC") {
                        $("#ccIn").empty().append(val["vluesIn"] + ' / ' + val["VluesTarget"]);
                    }
