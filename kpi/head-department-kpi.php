                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="card" style="padding-bottom:30px;">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-6">
                                                    <h5 class="card-header-text" style="margin-top: 30px;">Department KPIs</h5>
                                                </div>
                                                ...
                                                <div class="general-info">
                                                    <div class="card-header">
                                                        <div class="card-header-right" style="margin-right:25px; margin-bottom:30px;">
                                                            <h5>
                                                                <span id="ks" style="display:inline;"></span> / 100
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header pt-2 pb-2 btnh_primary">
                                            <h5 class="modal-title" id="exampleModalLabel">Department KPIs</h5>
...
<script>
    ...
    function sumScoreAll() {
        ...
        $("#ks").empty().append((sumValue/5*100).toFixed(2));
