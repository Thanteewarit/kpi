...
AND r1.evaluation_competency_id_staff = '$staff'";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="tabledit-edit-mode">
                                                                <select class="tabledit-input form-control input-sm" style="pointer-events:none;" onchange="upDateCompetency(this.value,'<?echo $r2['evaluation_competency_id']?>','<?echo $r2['competency_master_weight']?>','<?php echo $r2['evaluation_competency_code']?>','MC')">
