                                            ...
                                            <div class="page-header">
                                                <div class="card-block">
                                                    ...
                                                    <ul class="breadcrumb-title  p-t-10">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">อับไฟล์ Master KPIs </a>
                                                        </li>
                                                    </ul>
                                                    <div class="text-right">
                                                        <button type="button" class="btn btn-warning btn-outline-warning waves-effect md-trigger" data-modal="modal-15" onclick="ClearData()">Master KPIs</button>
                                                    </div>
                                                </div>
                                                <hr style="width: 95%;">
                                            </div>
                                            <div class="card-block">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $valuei = "SELECT * FROM tb_kpi_master_in WHERE fileTime ='" . $_SESSION['filename'] . "' AND fileTime !='' ";
                                                            foreach (c_scelectS($valuei) as $key => $r) {
                                                            ?>
                                                                
                                                                <tr>
                                                                    <td><?php echo $key + 1; ?></td>
                                                                    <td><?php echo $r['kpi_master_in_type']; ?></td>
                                                                    <td><?php echo $r['kpi_master_in_groub']; ?></td>
                                                                    <td><?php echo $r['kpi_master_in_factor']; ?></td>
                                                                    <td><?php echo $r['kpi_master_in_name']; ?></td>
                                                                    <td><?php echo $r['kpi_master_in_weight']; ?></td>
                                                                    <td><?php echo $r['kpi_master_in_target']; ?></td>
                                                                    <td><?php echo $r['kpi_master_in_standard_1']; ?></td>
                                                                    <td><?php echo $r['kpi_master_in_standard_2']; ?></td>
                                                                    <td><?php echo $r['kpi_master_in_standard_3']; ?></td>
                                                                    <td><?php echo $r['kpi_master_in_standard_4']; ?></td>
                                                                    <td><?php echo $r['kpi_master_in_standard_5']; ?></td>
                                                                </tr>
                                                            <?php
                                                            } ?>
                                                        </tbody>
                                            ...
                                            <form class="md-float-material" action="../class/sql-insert.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <input type="hidden" name="Mode" value="upCsvFileMasterKpi">
                                                    </div>
                                                </div>
