                            ...
                            <div class="page-body">
                                            ...
                                            <div class="page-header">
                                                <div class="card-block">
                                                    ...
                                                    <ul class="breadcrumb-title  p-t-10">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">อับไฟล์ Set Competency </a>
                                                        </li>
                                                    </ul>
                                                    <div class="text-right">
                                                        <button type="button" class="btn btn-warning btn-outline-warning waves-effect md-trigger" data-modal="modal-15" onclick="ClearData()">Set Competency</button>
                                                    </div>
                                                </div>
                                                <hr style="width: 95%;">
                                            </div>
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            JOIN tb_kpi_type as r2 on  r1.kpi_type_id = r2.kpi_type_id
                                                            JOIN tb_type_code as r3 ON r1.competency_master_type = r3.type_code_id
                                                            WHERE r1.fileTime ='" . $_SESSION['filename'] . "' 
                                                            AND r1.fileTime !='' ";
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $r['competency_master_name']; ?></td>
                                ...
                                <div class="md-modal md-effect-15" id="modal-15">
                                    <div class="md-content">
                                        <h3>อับโหลดไฟล์ Set Competency</h3>
                                            ...
                                            <form class="md-float-material" action="../class/sql-insert.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <input type="hidden" name="Mode" value="upCsvFileSetCompetency">
                                                    </div>
                                                </div>
