                                            ...
                                            <div class="page-header">
                                                <div class="card-block">
                                                    ...
                                                    <ul class="breadcrumb-title  p-t-10">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">อับไฟล์ Set Name </a>
                                                        </li>
                                                    </ul>
                                                    <div class="text-right">
                                                        <button type="button" class="btn btn-warning btn-outline-warning waves-effect md-trigger" data-modal="modal-15" onclick="ClearData()">Set Name</button>
                                                    </div>
                                                </div>
                                                <hr style="width: 95%;">
                                            </div>
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            JOIN tb_type_code as r3 ON r1.kpi_master_type = r3.type_code_id
                                                            JOIN tb_master_kpi AS r4 ON r4.master_kpi_id = r1.kpi_master_in_type
                                            ...
                                            <form class="md-float-material" action="../class/sql-insert.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <input type="hidden" name="Mode" value="upCsvFileSetKpi">
                                                    </div>
                                                </div>
