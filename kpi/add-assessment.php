...
GROUP BY r1.evaluation_code,r1.evaluation_year,r1.evaluation_month
";
                                        ...
                                        <div class="card-block" id="contents">
                                            <form class="md-float-material" action="../class/sql-insert.php" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" name="evaluation_start" class="form-control" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" name="evaluation_end" class="form-control" required>
