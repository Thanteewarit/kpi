...
$valuei =   "SELECT staff_hospital_id FROM tb_staff WHERE staff_code = '$staff'";
$hospital=c_scelectOne($valuei);
?>
    <!-- Favicon icon -->
...
<!--                                    Hospitals-->
                                    <div class="card" style="padding-bottom:30px;">
                                        <div class="card-header">
                                            <h5 class="card-header-text">Hospitals KPI</h5>  
                                        </div>
                                        <div class="card-block">
...
JOIN tb_kpi_master AS r2 ON r1.kpi_master_id = r2.kpi_master_id
JOIN tb_assessment_time AS r3 ON r3.assessment_time_code = r1.evaluation_code
WHERE r1.evaluation_all_hospital_id = '".$hospital['staff_hospital_id']."'
                                                ...
                                                <div class="general-info">
                                                    <div class="card-header">
                                                        <div class="card-header-right" style="margin-right:25px; margin-bottom:30px;">
                                                            <h5><?php echo $scoresTotal;?> / 5.00</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
AND r1.evaluation_competency_id_staff = '$staff'";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="tabledit-edit-mode">
                                                                <select class="tabledit-input form-control input-sm" onchange="upDateCompetency(this.value,'<?echo $r2['evaluation_competency_id']?>','<?echo $r2['competency_master_weight']?>')" disabled>
...
<!--                                    Job-->
                                    <div class="card" style="padding-bottom:30px;">
                                        <div class="card-header">
                                            <h5 class="card-header-text">Job KPIs</h5>
                                        </div>
...
AND r3.assessment_time_type = '3' ";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $r['kpi_master_weight']?></td>
                                                            <td><?php echo $r['kpi_master_target']?></td>
                                                            <td><input type="text" class="form-control k1<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_1']?>" disabled></td>

                                                            <td><input type="text" class="form-control k2<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_2']?>" disabled></td>

                                                            <td><input type="text" class="form-control k3<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_3']?>" disabled></td>

                                                            <td><input type="text" class="form-control k4<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_4']?>" disabled></td>

                                                            <td><input type="text" class="form-control k5<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_5']?>" disabled></td>

                                                            <td><input type="text" class="form-control k6<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_6']?>" disabled></td>

                                                            <td><input type="text" class="form-control k7<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_7']?>" disabled></td>

                                                            <td><input type="text" class="form-control k8<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_8']?>" disabled></td>

                                                            <td><input type="text" class="form-control k9<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_9']?>" disabled></td>

                                                            <td><input type="text" class="form-control k10<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_10']?>" disabled></td>

                                                            <td><input type="text" class="form-control k11<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_11']?>" disabled></td>

                                                            <td><input type="text" class="form-control k12<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_12']?>" disabled></td>
                                                            <td><input type="text" class="form-control" style="width: 70px;" value="<?php echo $r['evaluation_all_YTD']?>" disabled></td>
                                                            <td><input type="text" class="form-control" style="width: 70px;" value="<?php echo $r['evaluation_all_scor']?>" disabled></td>
                                                            <td><i class="icofont icofont-emo-laughing"></i></td>
                                                            <td><button class="btn btn-success btn-round btn-sm" onclick="villGraph(<?php echo $r['evaluation_all_id']?>);">view</button> </td>
