<?php $page="admim-kpi"; $ac="add-behavior-list"; session_start();?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <div class="page-header">
                                                <div class="card-block">
                                                    ...
                                                    <ul class="breadcrumb-title  p-t-10">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">เพิ่ม Behavior Code</a>
                                                        </li>
                                                    </ul>
...
WHERE r1.assessment_time_type = '8'
";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="../class/sql-insert.php?key=<?php echo TokenGen($r['assessment_time_code'], $secret)?>&Mode=delect-behavior-list">
...
-->
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <input type="hidden" name="assessment_time_type" value="8">
