                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                            <?php                                               
                                                            $valuei="
SELECT r1.evaluation_competency_code, r1.evaluation_competency_year, r1.evaluation_competency_month,
r3.staff_Name, r3.staff_Sername, r3.staff_code,r1.evaluation_start, r1.evaluation_end,
IF(r1.evaluation_competency_status='Y','ประเมินเเล้ว','ยังไม่ได้ประเมิน') AS ifStatus,
IF(r1.evaluation_competency_status='Y', 'info', 'danger') AS ifStatusC
FROM tb_evaluation_competency AS r1 
JOIN tb_staff AS r3 ON r1.evaluation_competency_id_staff = r3.staff_code
WHERE r1.evaluation_competency_code='".cut(TokenVerify($_GET['key'], $secret))."' 
AND r1.evaluation_competency_year='".date("Y")."' 
AND r1.evaluation_competency_month='".$_GET['month']."' 
GROUP BY r1.evaluation_competency_id_staff,r1.evaluation_competency_month";
                                                           ...
                                                           <tr>
                                                                ...
                                                                <td><?php echo $r['evaluation_competency_year']."-".$r['evaluation_competency_month'];?></td>
