<?php $page="list-competency"; $ac="add-competency"; session_start();?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <form class="md-float-material" action="../class/sql-insert.php"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <input type="hidden" name="assessment_time_type" value="4">
        ...
        $.ajax({
            ...
            success: function (jd) {
                $.each(jd, function (key, val) {
                    document.getElementById("assessment_time_code").value = val[
                        "assessment_time_code"];
                });
            }
        });
        //var datacide = $("#assessment_time_codes").val()+"-"+<?php echo date("Ym")?>;
...
<script>
    $('#data-table6').DataTable({
        ...
        serverSide: true,
        "ajax": {
            "url": "../class/class.php?Mode=add-competency-list.php",
            "type": "POST"
        }
