<?php $page="list-competency"; $ac="add-core"; session_start();?>
<!DOCTYPE html>
<html lang="en">
...
WHERE r1.assessment_time_type = '6'
";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="add-competency-inlist.php?key=<?php echo TokenGen($r['assessment_time_code'], $secret)?>"><button type="button" class="btn btn-primary btn-mini btn-outline-primary waves-effect md-trigger" data-modal="modal-add">ดูข้อมูล</button></a></td>
                                                            </tr>
...
-->
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <input type="hidden" name="assessment_time_type" value="6">
