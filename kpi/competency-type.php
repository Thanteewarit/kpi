<?php $page="list-competency"; $ac="competency-type"; session_start();?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <div class="page-header">
                                                <div class="card-block">
                                                    ...
                                                    <ul class="breadcrumb-title  p-t-10">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">GROUP Competency </a>
                                                        </li>
                                                    </ul>

                                                    <div class="text-right">
                                                        <button type="button" class="btn btn-warning btn-outline-warning waves-effect md-trigger" data-modal="modal-15" onclick="ClearData()">Add GROUP Competency</button>
                                                    </div>
...
";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><button onclick="villGraph(<?php echo $r['kpi_type_id']?>);" type="button" class="btn btn-success alert-confirm m-b-10 btn-sm">จัดการ</button></td>
                                                            </tr>
                                                            <?php } ?>
                                                        </tbody>
                                                        <tfoot>
                                        ...
                                        <div class="card-block" id="contents">
                                            <form class="md-float-material" action="../class/sql-insert.php" method="post">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="kpi_type_name"  class="form-control color-class" placeholder="ระบุชื่อการประเมิน" maxlength="100" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label">สถานะ </label>
                                                    <div class="col-sm-9">
                                                        <select name="kpi_type_status"  class="form-control" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <input type="hidden" name="kpi_types" value="2">
                                                        <input type="hidden" name="Mode" value="addTypeKpi">
                                ...
                                <div class="modal fade" id="villGraph" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="width: 90%; top: 200px; margin: auto;">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header pt-2 pb-2 btnh_primary">
                                                <h5 class="modal-title" id="exampleModalLabel">GROUP Competency</h5>
                                                ...
                                                <div class="card-block" id="contents">
                                                    <form class="md-float-material" action="../class/sql-insert.php" method="post">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <label class="col-sm-3 col-form-label"></label>
                                                            <div class="col-sm-9">
                                                                <button type="submit" name="addTime" class="btn btn-primary btn-md btn-block waves-effect text-left">SAVE</button>
                                                                <input type="hidden" name="kpi_type_id" id="kpi_type_id">
                                                                <input type="hidden" name="Mode" value="EditTypeKpi">
        ...
        $.ajax({
            ...
            success: function(jd) {
                $.each(jd, function(key, val) {
                    ...
                    $("#kpi_type_name").val(val["kpi_type_name"]);
                    $("#kpi_type_status").val(val["kpi_type_status"]);
                });
            }
        });
