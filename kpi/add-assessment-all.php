...
r3.staff_Name, r3.staff_Sername, r3.staff_code,r4.assessment_time_name, r5.level_position_name, 
IF(r1.evaluation_status='Y','ประเมินเเล้ว','ยังไม่ได้ประเมิน') AS ifStatus,
IF(r1.evaluation_status='Y', 'info', 'danger') AS ifStatusC
...
JOIN tb_assessment_time AS r4 ON r4.assessment_time_code = r1.evaluation_code
JOIN tb_level_position AS r5 ON r5.level_position_code = r3.staff_level_position
WHERE r1.evaluation_code='".cut(TokenVerify($_GET['key'], $secret))."' 
AND r1.evaluation_year='".date("Y")."' 
AND r1.evaluation_month='".$_GET['month']."' 
