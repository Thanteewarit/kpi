                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="simpletable"
                                                                ...
                                                                <tbody>
                                                                    <?php 
                                                            $valuei="select 
                                                                    r1.competency_master_id,
                                                            r1.competency_master_type, r1.kpi_type_id, r1.assessment_time_code,
                                                            r1.competency_master_name, r1.competency_master_weight, r1.competency_master_weight,
                                                            r1.competency_master_target, r1.competency_master_status,
                                                            IF(r1.competency_master_status='Y','เปิดใช้งาน','ระงับการใช้งาน') AS IFstatus,
                                                            IF(r1.competency_master_status='Y', 'info', 'danger') AS IFstatusColor,
                                                            r2.kpi_type_name,
                                                            (select SUM(competency_master_weight) FROM tb_competency_master WHERE assessment_time_code = '".cut(TokenVerify($_GET['key'], $secret))."')  AS SUMkpi_master_weight
                                                            from tb_competency_master AS r1
                                                            JOIN tb_kpi_type AS r2 ON r2.kpi_type_id = r1.kpi_type_id
                                                            WHERE r1.assessment_time_code = '".cut(TokenVerify($_GET['key'], $secret))."'
                                                            ORDER BY r2.kpi_type_name ASC
                                                            ";
                                                            foreach(c_scelectS($valuei) AS $key => $r){ ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="number" class="form-control"
                                                                                name="competency_master_weights[]"
                                                                                id="w<?php echo $r['competency_master_id']?>"
                                                                                style="width: 50px;"
                                                                                value="<?php echo $r['competency_master_weight']?>"
                                                                                onchange="ChangeTheValue(<?php echo $r['competency_master_id']?>)">
                                                                        </td>
                                                                        <td><input type="number" class="form-control"
                                                                                id="b<?php echo $r['competency_master_id']?>"
                                                                                style="width: 50px;"
                                                                                value="<?php echo $r['competency_master_target']?>"
                                                                                onchange="ChangeTheValueb(<?php echo $r['competency_master_id']?>)">
                                                                        </td>
                                                                        ...
                                                                        <td><a href="#"
                                                                                onclick="adddetile(<?php echo $r['competency_master_id']?>)">
                                                                                <button type="button"
                                                                                    class="btn btn-warning  waves-effect md-close"
                                                                                    style="margin-left: 0;">เพิ่มคำอธิบาย</button></a>
                                                                        </td>
                                                                        <td><a href="../class/sql-insert.php?Mode=delectMasterId&id=<?php echo $r['competency_master_id']?>" >
                                                                                <button type="button"
                                                                                    class="btn btn-warning  waves-effect md-close"
                                                                                    style="margin-left: 0;">ลบ</button></a>
                                                                        </td>
                                                                ...
                                                                <tfoot>
                                                                    <tr id="p1"
                                                                        ...
                                                                        <th>
                                                                            <div id="SUMcompetency_master_weights">
