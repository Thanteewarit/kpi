                                                    ...
                                                    <div class="page-header">
                                                        <div class="card-block">
                                                            ...
                                                            <ul class="breadcrumb-title  p-t-10">
                                                                ...
                                                                <li class="breadcrumb-item"><?php echo $arr["division_manager_sub_Name"];
                                                                                            ?>
                                                                </li>
                                                            </ul>
                                                            <div class="text-right">
                                                                <button type="button" class="btn btn-warning btn-outline-warning waves-effect md-trigger" onclick="clearValues()" data-modal="modal-15">เพิ่มชั้นที่ 5</button>
                                                            </div>
                                                        </div>
                                                        <hr style="width: 95%;">
                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $valuei = "
SELECT * ,IF(depatment_head_Status='Y','ใช่งาน','ปิดใช้งาน') AS IfStatus
FROM tb_depatment_head AS r1
JOIN tb_hospital_director_assistant AS r2 ON r2.director_assistant_id = r1.director_assistant_id
JOIN tb_division_manager_head AS r4 ON r4.division_manager_head_id = r1.division_manager_head_id
JOIN tb_division_manager_sub AS r5 ON r5.division_manager_sub_id = r1.division_manager_sub_id
JOIN tb_hospital AS r3 ON r3.hospital_id = r3.hospital_id
...
AND r1.division_manager_head_id = '" . $_SESSION["hospitaLslevel4"] . "'
AND r1.division_manager_sub_id = '" . $_SESSION["hospitaLslevel5"] . "'
                                                            ";
                                                                    foreach (c_scelectS($valuei) as $key => $r) { ?>
                                                                        <tr>
                                                                            <td>
                                                                                <?php echo $r['depatment_head_id']; ?>
                                                                            </td>
                                                                            ...
                                                                            <td><button class="btn btn-warning btn-sm" onclick="editFrom(<?php echo $r['depatment_head_id'] ?>)">Edit</button></td>
                                                                            <td><a href="../class/sql-insert.php?Mode=ckDelectL5&key=<?php echo TokenGen($r['depatment_head_id'], $secret) ?>"><button class="btn btn-danger btn-sm" onclick="return confirm('คุณต้องการลบข้อมูล?');">ลบทิ้ง</button></a></td>
                                            ...
                                            <div class="card-block">
                                                <form method="post" action="../class/sql-insert.php">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="depatment_head_Name" id="depatment_head_Name" required autocomplete="off">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="depatment_head_Status" class="form-control" required>
                                                    ...
                                                    <input type="hidden" class="form-control form-control-normal" name="Mode" value="addDepatmentHead">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="card-block" id="contents">
                                                        <form method="post" action="../class/sql-insert.php">
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">ชั้นที่ 5 </label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" name="depatment_head_Name" id="Edepatment_head_Name" required>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">Status </label>
                                                                <div class="col-sm-9">
                                                                    <select name="depatment_head_Status" id="Edepatment_head_Status" class="form-control" required>
                                                                        <option value="Y">ใช้งาน</option>
                                                                        <option value="N">ปิดการใช้งาน</option>
                                                                    </select>
                                                            ...
                                                            <input type="hidden" class="form-control form-control-normal" name="Mode" value="editDirector5">
                                                            <input type="hidden" name="depatment_head_id" id="Edepatment_head_id">
...
<script>
    ...
    function editFrom(id) {
        ...
        $.ajax({
            ...
            data: ({
                id: id,
                Mode: "getDepatmentHeadId"
            }),
            dataType: "JSON",
            async: false,
            success: function(jd) {
                $.each(jd, function(key, val) {
                    $("#Edepatment_head_id").val(val["depatment_head_id"]);
                    $("#Edepatment_head_Name").val(val["depatment_head_Name"]);
                    $("#Edepatment_head_Status").val(val["depatment_head_Status"]);
                });
            }
        });
    }
