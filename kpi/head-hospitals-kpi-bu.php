                                ...
                                <div class="page-wrapper">
                                    <div class="page-body">
                                        ...
                                        <div class="card-header">
                                            <h5 class="card-header-text">Hospitals KPIs</h5>
                                        </div>
...
AND r3.assessment_time_type = '1' ";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control kYtd<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_YTD']?>" <?php if ($r['evaluation_type']!="3"){ echo "disabled"; }?> onchange="upDateKpiYtd('<?php echo $r['evaluation_all_id']?>',this.value,<?php echo $r['kpi_master_id']?>);"></td>
...
<script>
    ...
    //อับเดท YTD 
    function upDateKpiYtd(id, YTD, kpi_master_id) {
    ...
    //คำนวน Scores
    function GetLevel(id, YTD,kpi_master_id) {
        console.log(kpi_master_id);
        $.ajax({
            url: "../class/class.php",
            global: false,
            ...
            success: function(jd) {
                $.each(jd, function(key, val) {
                    getScoreInscore(val["kpi_master_standard_1"], val["kpi_masterl_standard_2"], val["kpi_master_standard_3"], val["kpi_master_standard_4"], val["kpi_master_standard_5"], YTD, val["kpi_master_weight"], id,kpi_master_id)
    ...
    function getScoreInscore(v1, v2, v3, v4, v5, id, Weight, evaluation_all_id,kpi_master_id) {
        $.ajax({
            url: "../class/class-calculate.php",
            global: false,
            type: "POST",
