                                                ...
                                                <div class="card">
                                                        ...
                                                        <div class="card-block">
                                                            ...
                                                            <div class="text-right">
                                                                <button type="button"
                                                                    ...
                                                                    data-modal="modal-15">เพิ่ม KPI ตัวใหม่</button>
                                                                <!--                                                                <button type="button" class="btn btn-warning  waves-effect" onclick="openit()">เลือก KPI ที่มีอยู่</button>-->
                                                            </div>
                                                        </div>
                                                        <hr style="width: 95%;">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            ...
                                                            (select SUM(kpi_master_weight) FROM tb_kpi_master WHERE assessment_time_code = '".cut(TokenVerify($_GET['key'], $secret))."')  AS SUMkpi_master_weight,
                                                            ...
                                                            WHERE r1.assessment_time_code = '".cut(TokenVerify($_GET['key'], $secret))."'
                                                            ";
                                                            foreach(c_scelectS($valuei) AS $key => $r){ ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="number" class="form-control"
                                                                                name="kpi_master_weights[]"
                                                                                id="w<?php echo $r['kpi_master_id']?>"
                                                                                style="width: 50px;"
                                                                                value="<?php echo $r['kpi_master_weight']?>"
                                                                                onchange="ChangeTheValue(<?php echo $r['kpi_master_id']?>)">
                                                                        </td>
                                                                        <td><input type="number" class="form-control"
                                                                                name="kpi_master_target[]"
                                                                                id="T<?php echo $r['kpi_master_id']?>"
                                                                                style="width: 50px;"
                                                                                value="<?php echo $r['kpi_master_target']?>"
                                                                                onchange="ChangeTheValuetarget(<?php echo $r['kpi_master_id']?>)">
                                                                        </td>
                                                                        <td><input type="text" class="form-control"
                                                                                id="B1<?php echo $r['kpi_master_id']?>"
                                                                                style="width: 50px;"
                                                                                value="<?php echo $r['kpi_master_standard_1']?>"
                                                                                onchange="ChangeTheValues(<?php echo $r['kpi_master_id']?>,'1')">
                                                                        </td>
                                                                        <td><input type="text" class="form-control"
                                                                                id="B2<?php echo $r['kpi_master_id']?>"
                                                                                style="width: 50px;"
                                                                                value="<?php echo $r['kpi_masterl_standard_2']?>"
                                                                                onchange="ChangeTheValues(<?php echo $r['kpi_master_id']?>,'2')">
                                                                        </td>
                                                                        <td><input type="text" class="form-control"
                                                                                id="B3<?php echo $r['kpi_master_id']?>"
                                                                                style="width: 50px;"
                                                                                value="<?php echo $r['kpi_master_standard_3']?>"
                                                                                onchange="ChangeTheValues(<?php echo $r['kpi_master_id']?>,'3')">
                                                                        </td>
                                                                        <td><input type="text" class="form-control"
                                                                                id="B4<?php echo $r['kpi_master_id']?>"
                                                                                style="width: 50px;"
                                                                                value="<?php echo $r['kpi_master_standard_4']?>"
                                                                                onchange="ChangeTheValues(<?php echo $r['kpi_master_id']?>,'4')">
                                                                        </td>
                                                                        <td><input type="text" class="form-control"
                                                                                id="B5<?php echo $r['kpi_master_id']?>"
                                                                                style="width: 50px;"
                                                                                value="<?php echo $r['kpi_master_standard_5']?>"
                                                                                onchange="ChangeTheValues(<?php echo $r['kpi_master_id']?>,'5')">
                                                                        </td>
                                                                        <td><span
                                                                                class="pcoded-badge label label-<?php echo $r['IFstatusColor'];?>"><?php echo $r['IFstatus']?></span>
                                                                        </td>
                                                                        <td>ปิดการใช้งาน</td>
                                                                        <td><a href="../class/sql-insert.php?Mode=delHot&id=<?php echo $r['kpi_master_id']?>">[ลบ]</a></td> /
                                                                ...
                                                                <tfoot>
                                                                    <tr id="p1"
                                                                        <?php if($r['SUMkpi_master_weight']!=100){ echo 'style="background-color: red;"';}?>>
                                                                        <th colspan="3" class="text-right">น้ำหนักรวม
                                                                        </th>
                                                                        <th>
                                                                            <div id="SUMkpi_master_weight">
                                                                                <?php echo $r['SUMkpi_master_weight'];?>
                                                                            </div>
                                                                        </th>
                                                                        <th colspan="10">100 % </th>
                                                                    </tr>
                                                                </tfoot>
                                                            </table>
                                                        </div>
