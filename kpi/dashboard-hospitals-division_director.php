...
<head>
    ...
    <?php if($Tid!=""){ $_SESSION["director_assistant_id"]=$Tid; }?>
    <!-- Favicon icon -->
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                             <?php 
                                                            $valuei="
                                                            SELECT * FROM tb_division_director WHere director_assistant_id='".$_SESSION["director_assistant_id"]."' AND  division_director_Status = 'Y' ";
                                                            foreach(c_scelectS($valuei) AS $key => $r){ ?>
                                                            <tr>
                                                                 <td><?php echo $key+1;?></td>
                                                                <td><?php echo $r['division_director_Name'];?></td>
                                                                <td>3.5</td>
                                                                <td><a href="dashboard-hospitals-manager-head.php?key=<?php echo TokenGen($r['division_director_id'], $secret)?>"><button class="btn btn-info">ดูรายละเอียด</button></a></td>
