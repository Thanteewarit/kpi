...
<head>
    ...
    <?php if ($Tid != "") {
        $_SESSION["hospitaLslevel3"] = $Tid;
    } ?>
    <?php
    $valuei = "
    SELECT * 
    from tb_division_manager_head AS r1 
    ...
    JOIN tb_division_manager_head AS r5 ON r5.division_director_id = r1.division_director_id
    WHERE r3.hospital_id = '" . $_SESSION["hospitaLslevel1"] . "'
    AND r3.director_assistant_id = '" . $_SESSION["hospitaLslevel2"] . "'
    AND r5.division_director_id = '" . $_SESSION["hospitaLslevel3"] . "'
    ";
                                                    ...
                                                    <div class="page-header">
                                                        <div class="card-block">
                                                            ...
                                                            <div class="text-right">
                                                                <button type="button" class="btn btn-warning btn-outline-warning waves-effect md-trigger" data-modal="modal-15">เพิ่มชั้นที่ 3</button>
                                                            </div>
                                                        </div>
                                                        <hr style="width: 95%;">
                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $valuei = "
SELECT * , IF(division_manager_head_Status='Y','เปิดใช้งาน','ระงับการใช้งาน') AS IFStatus
from tb_division_manager_head AS r1
JOIN tb_division_director AS r2 ON r2.division_director_id = r1.division_director_id
JOIN tb_hospital_director_assistant AS r3 ON r3.director_assistant_id = r1.director_assistant_id
JOIN tb_hospital AS r4 ON r4.hospital_id = r3.hospital_id
...
AND r1.division_director_id = '" . $_SESSION["hospitaLslevel3"] . "'
    ";
                                                                    foreach (c_scelectS($valuei) as $key => $r) { ?>
                                                                        <tr>
                                                                            <td>
                                                                                <?php echo $r['division_manager_head_id']; ?>
                                                                            </td>
                                                                            ...
                                                                            <td><a href="division_manager_sub.php?key=<?php echo TokenGen($r['division_manager_head_id'], $secret) ?>"><button class="btn btn-info">ดูรายละเอียด</button></a></td>
                                                                            <td><button class="btn btn-warning btn-sm" onclick="editFrom(<?php echo $r['division_manager_head_id'] ?>)">Edit</button></td>
                                                                            <td><a href="../class/sql-insert.php?Mode=ckDelectL3&key=<?php echo TokenGen($r['division_manager_head_id'], $secret) ?>"><button class="btn btn-danger btn-sm" onclick="return confirm('คุณต้องการลบข้อมูล?');">ลบทิ้ง</button></a></td>
                                                                        </tr>
                                                                    <?php } ?>
                                                                </tbody>
                                                                <tfoot>
                                            ...
                                            <div class="card-block">
                                                <form method="post" action="../class/sql-insert.php">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select  name="division_director_id" id="division_director_id" class="form-control division_director_id" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="division_manager_head_Name" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="division_manager_head_Status" class="form-control" required>
                                                    ...
                                                    <input type="hidden" class="form-control form-control-normal" name="Mode" value="addDivisionManagerHead">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-block" id="contents">
                                                <form method="post" action="../class/sql-insert.php">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">ชั้นที่ 3 </label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="division_manager_head_Name" id="division_manager_head_Name" required>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Status </label>
                                                        <div class="col-sm-9">
                                                            <select name="division_manager_head_Status" id="division_manager_head_Status" class="form-control" required>
                                                                <option value="Y">ใช้งาน</option>
                                                                <option value="N">ปิดการใช้งาน</option>
                                                            </select>
                                                    ...
                                                    <input type="hidden" class="form-control form-control-normal" name="Mode" value="editDirector3">
                                                    <input type="hidden" name="division_manager_head_id" id="division_manager_head_id">
...
<script>
    ...
    function editFrom(id) {
        ...
        $.ajax({
            ...
            data: ({
                id: id,
                Mode: "getDivisionManagerHeadId"
            }),
            dataType: "JSON",
            async: false,
            success: function(jd) {
                $.each(jd, function(key, val) {
                    $("#division_manager_head_id").val(val["division_manager_head_id"]);
                    $("#division_manager_head_Name").val(val["division_manager_head_Name"]);
                    $("#division_manager_head_Status").val(val["division_manager_head_Status"]);
                });
            }
        });
    }
