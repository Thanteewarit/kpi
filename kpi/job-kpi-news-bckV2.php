                                                                        ...
                                                                        <table class="table">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-right"><?php echo $r['hospital_Code'];?></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <th scope="row"></th>
                                                                                    <td><div class="text-right"><a href="job-kpi-view.php?key=<?php echo $_GET['key']?>" target="_blank">
                                                                <button type="button" style="margin-top: 20px;" class="btn btn-warning alert-confirm m-b-10">ดูสรุปภาพรวมทั้งหมด</button></a>
...
AND r3.assessment_time_type = '3' ";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control k1<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_1']?>" <?php if ($month!="01"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k1'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control k2<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_2']?>" <?php if ($month!="02"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k2'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control k3<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_3']?>" <?php if ($month!="03"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k3'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control k4<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_4']?>" <?php if ($month!="04"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k4'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control k5<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_5']?>" <?php if ($month!="05"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k5'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control k6<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_6']?>" <?php if ($month!="06"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k6'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control k7<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_7']?>" <?php if ($month!="07"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k7'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control k8<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_8']?>" <?php if ($month!="08"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k8'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control k9<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_9']?>" <?php if ($month!="09"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k9'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control k10<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_10']?>" <?php if ($month!="10"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k10'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control k11<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_11']?>" <?php if ($month!="11"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k11'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control k12<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_12']?>" <?php if ($month!="12"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'k12'+<?php echo $r['evaluation_all_id'];?>)"></td>
...
AND r3.assessment_time_type = '8' ";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $r['kpi_master_weight']?></td>
                                                            <td><?php echo $r['kpi_master_target']?></td>
                                                            <td><input type="text" class="form-control b1<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_1']?>" <?php if ($month!="01"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b1'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control b2<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_2']?>" <?php if ($month!="02"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b2'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control b3<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_3']?>" <?php if ($month!="03"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b3'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control b4<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_4']?>" <?php if ($month!="04"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b4'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control b5<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_5']?>" <?php if ($month!="05"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b5'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control b6<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_6']?>" <?php if ($month!="06"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b6'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control b7<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_7']?>" <?php if ($month!="07"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b7'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control b8<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_8']?>" <?php if ($month!="08"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b8'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control b9<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_9']?>" <?php if ($month!="09"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b9'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control b10<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_10']?>" <?php if ($month!="10"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b10'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control b11<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_11']?>" <?php if ($month!="11"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b11'+<?php echo $r['evaluation_all_id'];?>)"></td>

                                                            <td><input type="text" class="form-control b12<?php echo $r['evaluation_all_id'];?>" style="width: 70px;" value="<?php echo $r['evaluation_all_month_12']?>" <?php if ($month!="12"){ echo "disabled"; }?> onClick="showmr(<?php echo $r["kpi_master_id"]?>,'b12'+<?php echo $r['evaluation_all_id'];?>)"></td>
                                                            <td><input type="text" class="form-control" style="width: 70px;" value="<?php echo $r['evaluation_all_YTD']?>" <?php if ($r['evaluation_type']!="3"){ echo "disabled"; }?> onchange="upDateKpiYtd('<?php echo $r['evaluation_all_id']?>',this.value);"></td>
                                                            <td></td>
                                                            <td><i class="icofont icofont-emo-laughing"></i></td>
                                                            <td><a href="#" onclick="villGraph(<?php echo $r['evaluation_all_id']?>);"><button class="btn btn-success btn-round btn-sm">view</button></a> </td>
        ...
        $.ajax({
            ...
            success: function(jd) {
                $.each(jd, function(key, val) {
                    ...
                    if (m1 > 0) { $("#k1").empty().append(m1);  }else{ m1 = null; }
                    if (m2 > 0) { $("#k2").empty().append(m2);  }else{ m2 = null; }
                    if (m3 > 0) { $("#k3").empty().append(m3);  }else{ m3 = null; }
                    if (m4 > 0) { $("#k4").empty().append(m4);  }else{ m4 = null; }
                    if (m5 > 0) { $("#k5").empty().append(m5);  }else{ m5 = null; }
                    if (m6 > 0) { $("#k6").empty().append(m6);  }else{ m6 = null; }
                    if (m7 > 0) { $("#k7").empty().append(m7);  }else{ m7 = null; }
                    if (m8 > 0) { $("#k8").empty().append(m8);  }else{ m8 = null; }
                    if (m9 > 0) { $("#k9").empty().append(m9);  }else{ m9 = null; }
                    if (m10 > 0) { $("#k10").empty().append(m10);   }else{ m10 = null; }
                    if (m11 > 0) { $("#k11").empty().append(m11);   }else{ m11 = null; }
                    if (m12 > 0) { $("#k12").empty().append(m12);   }else{ m12 = null; }
                    
                    if (val["evaluation_all_month_ytd1"] > 0) { mc1=val["evaluation_all_month_ytd1"]; }
                    if (val["evaluation_all_month_ytd2"] > 0) { mc2=val["evaluation_all_month_ytd2"]; }
                    if (val["evaluation_all_month_ytd3"] > 0) { mc3=val["evaluation_all_month_ytd3"]; }
                    if (val["evaluation_all_month_ytd4"] > 0) { mc4=val["evaluation_all_month_ytd4"]; }
                    if (val["evaluation_all_month_ytd5"] > 0) { mc5=val["evaluation_all_month_ytd5"]; }
                    if (val["evaluation_all_month_ytd6"] > 0) { mc6=val["evaluation_all_month_ytd6"]; }
                    if (val["evaluation_all_month_ytd7"] > 0) { mc7=val["evaluation_all_month_ytd7"]; }
                    if (val["evaluation_all_month_ytd8"] > 0) { mc8=val["evaluation_all_month_ytd8"]; }
                    if (val["evaluation_all_month_ytd9"] > 0) { mc9=val["evaluation_all_month_ytd9"]; }
                    if (val["evaluation_all_month_ytd10"] > 0) { mc10=val["evaluation_all_month_ytd10"]; }
                    if (val["evaluation_all_month_ytd11"] > 0) { mc11=val["evaluation_all_month_ytd11"]; }
                    if (val["evaluation_all_month_ytd12"] > 0) { mc12=val["evaluation_all_month_ytd12"]; }
        ...
        $.ajax({
            ...
            success: function(jd) {
                $.each(jd, function(key, val) {
                    ...
                    if (m1 > 0) {  $("#c1").empty().append(m1);  }else{ m1 = null; }
                    if (m2 > 0) { $("#c2").empty().append(m2);   }else{ m2 = null; }
                    if (m3 > 0) { $("#c3").empty().append(m3);   }else{ m3 = null; }
                    if (m4 > 0) { $("#c4").empty().append(m4);   }else{ m4 = null; }
                    if (m5 > 0) { $("#c5").empty().append(m5);   }else{ m5 = null; }
                    if (m6 > 0) { $("#c6").empty().append(m6);   }else{ m6 = null; }
                    if (m7 > 0) { $("#c7").empty().append(m7);   }else{ m7 = null; }
                    if (m8 > 0) { $("#c8").empty().append(m8);   }else{ m8 = null; }
                    if (m9 > 0) { $("#c9").empty().append(m9);   }else{ m9 = null; }
                    if (m10 > 0) { $("#c10").empty().append(m10);   }else{ m10 = null; }
                    if (m11 > 0) { $("#c11").empty().append(m11);   }else{ m11 = null; }
                    if (m12 > 0) { $("#c12").empty().append(m12);   }else{ m12 = null; }
