                                            ...
                                            <div class="page-header">
                                                <div class="card-block">
                                                    ...
                                                    <ul class="breadcrumb-title  p-t-10">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">อับไฟล์ รายชื่อพนักงาน </a>
                                                        </li>
                                                    </ul>
                                                    <div class="text-right">
                                                        <button type="button" class="btn btn-warning btn-outline-warning waves-effect md-trigger" data-modal="modal-15" onclick="ClearData()">เพิ่มพนักงาน</button>
                                                    </div>
                                                </div>
                                                <hr style="width: 95%;">
                                            </div>
                                            <div class="card-block">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="footer-search" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $valuei="SELECT * FROM tb_staff WHERE fileTime ='".$_SESSION['filename']."' AND fileTime!='' ";
                                                            foreach (c_scelectS($valuei) as $key => $r) { 
                                                            ?>
                                                                <tr>
                                                                    <td><?php echo $key+1; ?></td>
                                                                    <td><?php echo $r['staff_code']; ?></td>
                                                                    <td><?php echo $r['staff_title']; ?></td>
                                                                    ...
                                                                    <td><?php echo $r['staff_hospital_id']; ?></td>
                                                                    <td><?php echo $r['staff_director_assistant_id']; ?></td>
                                                                    <td><?php echo $r['staff_division_director_id'];?></td>
                                                                    <td><?php echo $r['staff_division_manager_head_id']; ?></td>
                                                                    <td><?php echo $r['staff_division_manager_sub_id']; ?></td>
                                                                    <td><?php echo $r['staff_depatment_head_id']; ?></td>
                                                                    <td><?php echo $r['staff_start']; ?></td>
                                                                    <td><?php echo $r['staff_level_position']; ?></td>
                                                                    <td><?php echo $r['staff_end']; ?></td>
                                                                    <td><?php echo $r['staff_level']; ?></td>
                                            ...
                                            <form class="md-float-material" action="../class/sql-insert.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <input type="hidden" name="Mode" value="upCsvFile">
                                                    </div>
                                                </div>
